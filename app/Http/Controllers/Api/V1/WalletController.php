...
class WalletController extends Controller
{
    ...
    public function fund_transfer(Request $request)
    {
        ...
        $wallet_transaction_from = CustomerLogic::create_wallet_transaction($from_user, $request->amount, 'fund_transfer',$request->referance);
        $wallet_transaction_to = CustomerLogic::create_wallet_transaction($to_user, $request->amount, 'add_fund_by_transfer',$request->referance);
