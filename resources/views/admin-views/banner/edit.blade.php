                                ...
                                <div class="col-lg-6">
                                    <div class="h-100 d-flex flex-column">
                                        ...
                                        <center class="py-3 my-auto">
                                            <img class="img--vertical" id="viewer" onerror="this.src='{{asset('assets/admin/img/900x400/img1.jpg')}}'" src="{{asset('storage/app/public/banner')}}/{{$banner['image']}}" alt="campaign image"/>
                                        </center>
