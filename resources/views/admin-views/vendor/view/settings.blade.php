                    ...
                    <div class="row g-3">
                        <div class="col-sm-6 col-lg-4">
                            <div class="form-group mb-0">
                                ...
                                <span class="pr-2">{{translate('messages.manage_item_setup')}}<span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{translate('By disabling this field, the store can`t manage items, which means the store web panel app won`t get the access for managing items')}}"><img src="{{asset('assets/admin/img/info-circle.svg')}}" alt="{{translate('messages.show_hide_food_menu')}}"></span></span>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="form-group mb-0">
                                ...
                                <span class="pr-2">{{translate('messages.Show_Reviews_In_Store_Panel')}}<span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{translate('If this field is active, the store panel & store app can see the customer`s review')}}"><img src="{{asset('assets/admin/img/info-circle.svg')}}" alt="{{translate('messages.show_hide_food_menu')}}"></span> </span>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="form-group mb-0">
                                ...
                                <span class="pr-2 text-capitalize">{{translate('messages.include_POS_in_store_panel')}}<span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{translate('If this option is turned on, the store panel will get the
                                    Point of Sale (POS) option')}}"><img src="{{asset('assets/admin/img/info-circle.svg')}}" alt="{{__('messages.pos_system_hint')}}"></span></span>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="form-group mb-0">
                                ...
                                <span class="pr-2">{{translate('messages.scheduled')}} {{translate('messages.order_option')}}<span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{translate('If this status is turned on, the customer is able to place a scheduled
                                    order for this store')}}"><img src="{{asset('assets/admin/img/info-circle.svg')}}" alt="{{__('messages.scheduled_order_hint')}}"></span></span>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="form-group mb-0">
                                ...
                                <span class="pr-2 text-capitalize">{{translate('messages.self_delivery')}}<span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{translate('When this option is enabled, stores need to deliver orders by themselves or
                                    ...
                                    from the store panel')}}"><img src="{{asset('assets/admin/img/info-circle.svg')}}" alt="{{__('messages.self_delivery_hint')}}"></span></span>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="form-group mb-0">
                                <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border border-secondary rounded px-4 form-control" for="delivery">
                                    <span class="pr-2">{{translate('messages.home_delivery')}}<span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{translate('messages.home_delivery_hint')}}"><img src="{{asset('assets/admin/img/info-circle.svg')}}" alt="{{__('messages.home_delivery_hint')}}"></span></span>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="form-group mb-0">
                                ...
                                <span class="pr-2 text-capitalize">{{translate('messages.take_away')}}<span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{__('messages.take_away_hint')}}"><img src="{{asset('assets/admin/img/info-circle.svg')}}" alt="{{__('messages.take_away_hint')}}"></span></span>
                            ...
                            @if ($prescription_order_status)
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group mb-0">
                                        ...
                                        <span class="pr-2 text-capitalize">{{translate('messages.prescription_order')}}<span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{__('messages.prescription_order_hint')}}"><img src="{{asset('assets/admin/img/info-circle.svg')}}" alt="{{__('messages.prescription_order_hint')}}"></span></span>
                    ...
                    <div class="row g-3 mt-3">
                        <form action="{{route('admin.store.update-settings',[$store['id']])}}" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-6 col-lg-4">
                                    <label class="input-label text-capitalize" for="maximum_delivery_time">{{translate('messages.minimum_processing_time')}}<span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{translate('messages.minimum_processing_time_warning')}}"><img src="{{asset('assets/admin/img/info-circle.svg')}}" alt="{{translate('messages.minimum_processing_time_warning')}}"></span></label>
                                ...
                                <div class="form-group col-sm-6 col-lg-4">
                                    <div class="form-group">
                                        <label class="d-flex mb-1 justify-content-between switch toggle-switch-sm text-dark text-capitalize" for="comission_status">
                                            <span>{{translate('messages.admin_commission')}}(%) <span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{translate('messages.if_sales_commission_disabled_system_default_will_be_applicable')}}"><img src="{{asset('assets/admin/img/info-circle.svg')}}" alt="{{translate('messages.if_sales_commission_disabled_system_default_will_be_applicable')}}"></span></span>
